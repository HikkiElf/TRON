...
def roundCount(color: pygame.Color):
    ...
    pygame.draw.circle(playSurface, white, [386, 20], 10, 1)
    pygame.draw.circle(playSurface, white, [408, 20], 10, 1)
    pygame.draw.circle(playSurface, white, [430, 20], 10, 1)
    pygame.draw.circle(playSurface, white, [452, 20], 10, 1)
    pygame.draw.circle(playSurface, white, [474, 20], 10, 1)
    pygame.draw.circle(playSurface, white, [496, 20], 10, 1)
    pygame.draw.circle(playSurface, white, [518, 20], 10, 1)
    ...
    pygame.draw.circle(playSurface, white, [898, 20], 10, 1)
    pygame.draw.circle(playSurface, white, [876, 20], 10, 1)
    pygame.draw.circle(playSurface, white, [854, 20], 10, 1)
    pygame.draw.circle(playSurface, white, [832, 20], 10, 1)
    pygame.draw.circle(playSurface, white, [810, 20], 10, 1)
    pygame.draw.circle(playSurface, white, [788, 20], 10, 1)
    pygame.draw.circle(playSurface, white, [766, 20], 10, 1)
    ...
    if color == red:
        ...
        if redBikeScore >= 4:
            ...
            pygame.draw.circle(playSurface, red, [342, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [364, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [386, 20], 9, 0)
        if redBikeScore >= 5:
            pygame.draw.circle(playSurface, red, [320, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [342, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [364, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [386, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [408, 20], 9, 0)
        if redBikeScore >= 6:
            pygame.draw.circle(playSurface, red, [320, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [342, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [364, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [386, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [408, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [430, 20], 9, 0)
        if redBikeScore >= 7:
            pygame.draw.circle(playSurface, red, [320, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [342, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [364, 20], 9, 0)
            ...
            pygame.draw.circle(playSurface, red, [408, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [430, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [452, 20], 9, 0)
        if redBikeScore >= 8:
            pygame.draw.circle(playSurface, red, [320, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [342, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [364, 20], 9, 0)
            ...
            pygame.draw.circle(playSurface, red, [430, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [452, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [474, 20], 9, 0)
        if redBikeScore >= 9:
            pygame.draw.circle(playSurface, red, [320, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [342, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [364, 20], 9, 0)
            ...
            pygame.draw.circle(playSurface, red, [452, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [474, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [496, 20], 9, 0)
        if redBikeScore >= 10:
            pygame.draw.circle(playSurface, red, [320, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [342, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [364, 20], 9, 0)
            ...
            pygame.draw.circle(playSurface, red, [474, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [496, 20], 9, 0)
            pygame.draw.circle(playSurface, red, [518, 20], 9, 0)
    ...
    if color == blue:
        ...
        if blueBikeScore >= 4:
            ...
            pygame.draw.circle(playSurface, blue, [942, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [920, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [898, 20], 9, 0)
        if blueBikeScore >= 5:
            pygame.draw.circle(playSurface, blue, [964, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [942, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [920, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [898, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [876, 20], 9, 0)
        if blueBikeScore >= 6:
            pygame.draw.circle(playSurface, blue, [964, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [942, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [920, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [898, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [876, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [854, 20], 9, 0)
        if blueBikeScore >= 7:
            pygame.draw.circle(playSurface, blue, [964, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [942, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [920, 20], 9, 0)
            ...
            pygame.draw.circle(playSurface, blue, [876, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [854, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [832, 20], 9, 0)
        if blueBikeScore >= 8:
            pygame.draw.circle(playSurface, blue, [964, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [942, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [920, 20], 9, 0)
            ...
            pygame.draw.circle(playSurface, blue, [854, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [832, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [810, 20], 9, 0)
        if blueBikeScore >= 9:
            pygame.draw.circle(playSurface, blue, [964, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [942, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [920, 20], 9, 0)
            ...
            pygame.draw.circle(playSurface, blue, [832, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [810, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [788, 20], 9, 0)
        if blueBikeScore >= 10:
            pygame.draw.circle(playSurface, blue, [964, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [942, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [920, 20], 9, 0)
            ...
            pygame.draw.circle(playSurface, blue, [810, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [788, 20], 9, 0)
            pygame.draw.circle(playSurface, blue, [766, 20], 9, 0)
